...
public class QnaDAO {
	...
	public int insertArticle(QnaBean article, int qna_id){
        Connection conn = null;
        PreparedStatement pstmt = null;
		ResultSet rs = null;
		int x = 0;
	...
	public List<QnaBean> getArticles(int count){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        List<QnaBean> articleList=null;//글목록을 저장하는 객체
        try {
            conn = getConnection();
            ...
            if (rs.next()) {//ResultSet이 레코드를 가짐
                articleList = new ArrayList<QnaBean>(count);
                do{
	...
	public List<QnaBean> getArticles(int count, int book_id){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        List<QnaBean> articleList=null;//글목록을 저장하는 객체
    ...
    public QnaBean updateGetArticle(int qna_id){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
